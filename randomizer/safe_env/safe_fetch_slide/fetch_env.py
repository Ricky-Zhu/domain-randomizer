...
class FetchEnv(robot_env.RobotEnv):
    ...
    def _sample_goal(self):
        ...
        # make sure the goal's x position is within (1.7,1.8) which is far from the gripper
        goal[0] = 1.75 + self.np_random.uniform(-0.05, 0.05, size=1)[0]
        goal[1] = 0.75 + self.np_random.uniform(-0.05, 0.05, size=1)[0]
